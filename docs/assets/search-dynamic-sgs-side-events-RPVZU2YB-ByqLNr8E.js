const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-Djk9QhX9.js","assets/index-ubRpzSP4.js","assets/index-Bkqb9vlF.css"])))=>i.map(i=>d[i]);
import{x as e,s as t,_ as B,v as D}from"./index-ubRpzSP4.js";import{p as R}from"./chunk-Y3BVWVFU-BMEBwjMP.js";var a=null;async function S(){return a??(a=n())}async function n(){return R(await e.kpuzzle(),`SubgroupSizes 24 21 18 15 12 9 6
...
Alg U BR2' U R' U2' L U2 R U' BR2 U' L'`)}var s=null;async function y(){return s??(s=m())}async function b(){return{ordering:(await y()).ordering.slice(2)}}async function m(){return R(await t.pyraminx.kpuzzle(),`SubgroupSizes 12 9 12 3 10 3 8 6 2 3 3 3 3
...
Alg U R' U' L B R' B' R
Alg R' U' R U B' U' B L`)}export{S as cachedData222,u as cachedMegaminxKPuzzleWithoutMO,h as cachedSGSDataMegaminx,y as sgsDataPyraminx,b as sgsDataPyraminxFixedOrientation,f as sgsDataSkewb,G as sgsDataSkewbFixedCorner,d as skewbKPuzzleWithoutMOCached};
