const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-QfCD0Aev.js","assets/index-T3QftZEK.js","assets/index-DMwc-pkD.css"])))=>i.map(i=>d[i]);
import{z as e,_ as B,K as D,w as t}from"./index-T3QftZEK.js";import{p as R}from"./chunk-6APJHPXM-EUqjrk1P.js";var a=null;async function S(){return a??(a=n())}async function n(){return R(await e.kpuzzle(),`SubgroupSizes 24 21 18 15 12 9 6
...
Alg U BR2' U R' U2' L U2 R U' BR2 U' L'`)}var s=null;async function y(){return s??(s=z())}async function b(){return{ordering:(await y()).ordering.slice(2)}}async function z(){return R(await t.pyraminx.kpuzzle(),`SubgroupSizes 12 9 12 3 10 3 8 6 2 3 3 3 3
...
Alg u
Alg u'`)}async function m(){const{getPuzzleGeometryByName:g,ExperimentalPGNotation:A}=await B(async()=>{const{getPuzzleGeometryByName:l,ExperimentalPGNotation:F}=await import("./index-QfCD0Aev.js");return{getPuzzleGeometryByName:l,ExperimentalPGNotation:F}},__vite__mapDeps([0,1,2])),L=g("skewb",{allMoves:!0,addRotations:!0});return new D(L.getKPuzzleDefinition(!0),{experimentalPGNotation:new A(L,L.getOrbitsDef(!0))})}var d=null;async function v(){return d??(d=m())}var p=null;async function f(){return p??(p=P())}async function G(){return{ordering:(await f()).ordering.slice(1)}}async function P(){return R(await v(),`SubgroupSizes 24 6 5 12 9 3 4 9 3 3
